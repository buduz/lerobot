...
# from robot import BaseInferenceServer
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/home/zhiheng/project/LAR_baseline/lerobot/outputs/DP/10-shot/step_100000"
    )

    parser.add_argument("--port", type=int, help="Port number for the server.", default=5550)
    parser.add_argument(
